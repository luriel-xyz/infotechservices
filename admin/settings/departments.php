	...
	<div class="d-flex" id="wrapper">
		...
		<div class="h-100 w-100">
			...
			<div class="container-fluid h-100" style="margin-top: 80px;">
				<div class="row">
					<p class="h3 mx-auto"> <i class="fa fa-building-o" aria-hidden="true"></i> Departments </p>
				</div>
					...
					<div class="col-lg-3">
						<div class="input-group">
							...
							<div class="input-group-append">
								<button type="button" class="btn btn-primary" id="add" data-toggle="tooltip" title="Add Department"><i class="fa fa-plus" aria-hidden="true"></i> <i class="fa fa-building" aria-hidden="true"></i></button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div id="add-form">
							<?php
							include_once('../../forms/department-addingform.php');
							?>
						</div>
						<!-- /#Add Modal -->
			...
			<div class="container-fluid mt-2">
				<?php
				include_once('../../tables/department-tbl.php');
				?>
			</div>
			<!--/#Table Container-->
		...
		$(".edit").click(function(e) {
			...
			$.ajax({
				...
				$.each(data, function(index, value) {
					...
					$('#dept_id').append('<input type="hidden" name="dept_id" id="dept_id" value=' + value.dept_id + '>');
					$('#dept_code').val(value.dept_code);
