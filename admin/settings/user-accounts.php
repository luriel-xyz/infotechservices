    ...
    <div class="h-100 w-100">
	    ...
	    <div class="container-fluid h-100" style="margin-top: 80px;">
	    	...
	    	<div class="row" >
	    		...
	    		<div class="col-xs-3">
	               	<button type="button" class="btn btn-primary" id="addPersonnelAccount" data-toggle="tooltip" title="Add Personnel Account"><i class="fa fa-user-plus" aria-hidden="true"></i>Admin</button>
	            </div>
		        <div class="col-xs-4 pl-2">
		            <button type="button" class="btn btn-primary" id="addDeptAccount" data-toggle="tooltip" title="Add Department Account"><i class="fa fa-user-plus" aria-hidden="true"></i>Department</button>
	      		</div>
	...
	//Edit User Accounts Script
 	$(".edit").click(function(e){
	    ...
	    $.ajax({
	    	url: "../../config/processors/settingsArguments.php",
	    	type: "post",
	    	data: {action:action, useraccount_id:useraccount_id},
	    	dataType: 'JSON',
	    }).done(function(data){
