            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div class="form-group">
                  <label>Notes: </label>
                  <div>
                    <textarea name="notes" id="" class="form-control" cols="20" rows="3" placeholder="Notes"></textarea>
                  </div>
                </div>
                <!-- /# Issued To Field -->
              </div>
...
<script>
  ...
  $('.assess').click(function(e) {
    ...
    /** 
      TODO: redirect to assessment form page
       
    */
    // (window).open('../forms/repassessmentreport-creationform.php');
