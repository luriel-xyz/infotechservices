        ...
        <tr>
            ...
            <td> <?=$value['status']?>
              ...
              if($value['statusupdate_useraccount_id'] != ""){
                $getUserAccount = $control->getUserAccount($value['statusupdate_useraccount_id']);
                foreach ($getUserAccount as $key => $userValue) {
                 $getTechRepEmployee = $control->getEmployee($userValue['emp_id']);
                }
                foreach($getTechRepEmployee as $val ){
                  echo 'by ' . '<b>' . $val['emp_fname'] . '</b>';
                } 
              }
              ?> 
            </td>
