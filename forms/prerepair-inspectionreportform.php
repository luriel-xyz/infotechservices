							...
							<table class="table " style="text-align: center;">
								<thead>
									...
									<tr>
										<th>
											<center>
												<p6 class="card-title" style="color: white;">Qty</p6>
											</center>
										</th>
										<th>
											<center>
												<p6 class="card-title" style="color: white;">Unit</p6>
											</center>
										</th>
										<th>
											<center>
												<p6 class="card-title" style="color: white;">Particulars/Description</p6>
											</center>
										</th>
										<th>
											<center>
												<p6 class="card-title" style="color: white;">Amount</p6>
											</center>
										</th>
